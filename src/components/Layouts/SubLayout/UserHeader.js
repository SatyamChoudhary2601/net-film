      ...
      <div>
        ...
        >
          ...
          <ul className="navbar-nav desktop-nav ">
            ...
            <li className="nav-item" key="series-header">
              <Link className="nav-link" to={`/ecom-store`}>
                {t("E-Commerce Store")}
              </Link>
            </li>
          </ul>
          ...
          <div className="sidebar-content">
            ...
            <ul className="sidebar-menu" id="mobile-side-menu">
              ...
              <li key="series-mobile-header">
                <Link to={`/genre/${apiConstants.SERIES}`}>{t("series")}</Link>
              </li>

              <li key="movies-mobile-header">
                <Link to={`/genre/${apiConstants.MOVIES}`}>{t("movies")}</Link>
              </li>

              <li key="kids-mobile-header">
                <Link to={`/genre/${apiConstants.KIDS}`}>{t("kids")}</Link>
              </li>
